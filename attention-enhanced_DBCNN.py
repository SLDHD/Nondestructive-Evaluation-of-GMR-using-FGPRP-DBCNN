...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Attention-enhanced DBCNN training and evaluation")
    parser.add_argument("--data_dir", type=str, required=True,
                        help="Path to FGPRP image dataset")
    parser.add_argument("--snr", type=float, default=3,
                        help="Noise SNR in dB")
    ...
    transform = transforms.Compose([
        ...
        transforms.ToTensor(),
        AddGaussianNoise(snr_db=args.snr),
    ...
    print(
        ...
        f"best val acc = {checkpoint['best_val_acc']:.2f}%"
    )
    ...
    metrics_file = f"metrics_seed_{args.seed}.csv"
